      ...
      <aside className="w-64 bg-sidebar backdrop-blur-xl border-r border-sidebar-border p-6 flex flex-col h-screen z-10 shadow-2xl shrink-0">
        ...
        <nav className="flex-1 space-y-6">
          <div className="space-y-1">
            ...
            <Link href="/dashboard" className="block px-4 py-2.5 rounded-lg text-sm font-medium bg-primary/20 text-primary border border-primary/30 shadow-[0_0_15px_rgba(59,130,246,0.1)] transition-all relative overflow-hidden">
